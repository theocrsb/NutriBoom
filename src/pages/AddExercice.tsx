...
useEffect(()=>{
    ...
    axios.get(`http://localhost:8080/api/activity`, {headers: { Authorization:`Bearer ${localStorage.getItem("accesstoken")}` }})
    .then((response)=>{
    ...
    return(
          <div> 
            ...
            <p className="exerciceText">Tu peux grâce à la barre de recherche trouver ton activité, et l'ajouter à ton tableau de bord grâce au bouton!</p>
